...
public class LogInView extends View {
    public LogInView() { menu = new LogIn(); }
    ...
    public void input() {
        ...
        if (loginMatcher.matches()) {
            ...
            System.out.println(((LogIn) menu).login(username, password, stayLoggedIn));
            ...
            if (answerMatcher.matches()) {
                ...
                System.out.println(((LogIn) menu).resetPassword(username, answer, newPassword));
            } else {
