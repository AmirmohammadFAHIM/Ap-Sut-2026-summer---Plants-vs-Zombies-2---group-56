...
public class ZombieFactory {
    ...
    public static Zombie createZombie(String type , int row) {

        // ====== 1. NORMAL ======
        if (type.equals("normal") || type.equals("ZombieDefault")) {
            return new Zombie(type, type, row, 190, 100, 0.185f, 100, 32, 95);
        }

        // ====== 2. CONEHEAD ======
        if (type.equals("cone") || type.equals("ZombieArmor1")) {
            Zombie z = new Zombie(type, type, row, 190, 100, 0.185f, 200, 32, 95);
        ...
        if (type.equals("bucket") || type.equals("ZombieArmor2")) {
            Zombie z = new Zombie(type, type, row, 190, 100, 0.185f, 400, 32, 95);
        ...
        if (type.equals("knight") || type.equals("ZombieDarkArmor3")) {
            Zombie z = new Zombie(type, type, row, 190, 100, 0.185f, 550, 32, 95);
        ...
        if (type.equals("brick") || type.equals("ZombieArmor4")) {
            Zombie z = new Zombie(type, type, row, 190, 100, 0.185f, 700, 32, 95);
        ...
        if (type.equals("gargantuar") || type.equals("ZombieGargantuar")) {
            Zombie z = new Zombie(type, type, row, 3600, 1500, 0.24f, 1500, 62, 95);
        ...
        if (type.equals("imp") || type.equals("ZombieImp")) {
            return new Zombie(type, type, row, 190, 100, 0.22f, 100, 20, 80);
        }

        // ====== 8. ALL STAR ======
        if (type.equals("allstar") || type.equals("ZombieModernAllStar")) {
            Zombie z = new Zombie(type, type, row, 1100, 1500, 0.22f, 1000, 42, 95);
        ...
        if (type.equals("arcade") || type.equals("ZombieArcade")) {
            Zombie z = new Zombie(type, type, row, 490, 100, 0.19f, 600, 32, 95);
        ...
        if (type.equals("turquoise") || type.equals("ZombieCamelDefault")) {
            Zombie z = new Zombie(type, type, row, 380, 100, 0.185f, 300, 32, 95);
        ...
        if (type.equals("prospector") || type.equals("ZombieProspector")) {
            Zombie z = new Zombie(type, type, row, 190, 100, 0.16f, 200, 32, 95);
        ...
        if (type.equals("newspaper") || type.equals("ZombieNewspaper")) {
            Zombie z = new Zombie(type, type, row, 460, 200, 0.22f, 700, 32, 95);
        ...
        if (type.equals("barrel") || type.equals("ZombieBarrel")) {
            Zombie z = new Zombie(type, type, row, 100, 0, 0.185f, 150, 32, 95);
        ...
        if (type.equals("ra") || type.equals("ZombieRa")) {
            Zombie z = new Zombie(type, type, row, 190, 100, 0.2f, 100, 32, 95);
            z.addAbility(new SunRobbingAbility(250, 25));
            return z;
        }
        ...
        if (type.equals("explorer") || type.equals("ZombieExplorer")) {
            Zombie z = new Zombie(type, type, row, 250, 100, 0.25f, 250, 32, 95);
        ...
        if (type.equals("dodo") || type.equals("ZombieIceAgeDodo")) {
            Zombie z = new Zombie(type, type, row, 490, 100, 0.3f, 600, 46, 95);
        ...
        if (type.equals("hunter") || type.equals("ZombieIceAgeHunter")) {
            Zombie z = new Zombie(type, type, row, 700, 100, 0.12f, 500, 32, 95);
        ...
        if (type.equals("troglobite") || type.equals("ZombieIceAgeTroglobite")) {
            Zombie z = new Zombie(type, type, row, 470, 100, 0.185f, 600, 32, 95);
        ...
        if (type.equals("fisherman") || type.equals("ZombieBeachFisherman")) {
            Zombie z = new Zombie(type, type, row, 1000, 100, 0.185f, 700, 32, 95);
        ...
        if (type.equals("octopus") || type.equals("ZombieBeachOctopus")) {
            Zombie z = new Zombie(type, type, row, 910, 100, 0.12f, 900, 32, 95);
            z.addAbility(new BulletAbility(BulletType.ICE, 2.0f, 4.0f));
            return z;
        }
        ...
        if (type.equals("wizard") || type.equals("ZombieWizard")) {
            Zombie z = new Zombie(type, type, row, 490, 100, 0.12f, 800, 32, 95);
        ...
        if (type.equals("king") || type.equals("ZombieDarkKing")) {
            Zombie z = new Zombie(type, type, row, 1000, 100, 0.185f, 750, 32, 95);
            z.addAbility(new RandomChooserAbility(
                    4.0f, 10.0f,
        ...
        if (type.equals("dragon_imp") || type.equals("ZombieDarkImpDragon")) {
            Zombie z = new Zombie(type, type, row, 190, 100, 0.185f, 150, 20, 80);
