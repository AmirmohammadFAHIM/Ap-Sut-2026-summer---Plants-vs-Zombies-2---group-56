...
public class ZombieFactory {
    ...
    public static Zombie createZombie(String type) {
        ...
        if (type.equals("normal") || type.equals("ZombieDefault")) {
            return new Zombie(type, type, 190, 100, 0.185f, 32, 95);
        }

        // ====== 2. CONEHEAD ======
        if (type.equals("cone") || type.equals("ZombieArmor1")) {
            Zombie z = new Zombie(type, type, 190, 100, 0.185f, 32, 95);
        ...
        if (type.equals("gargantuar") || type.equals("ZombieGargantuar")) {
            Zombie z = new Zombie(type, type, 3600, 1500, 0.24f, 62, 95);
        ...
        if (type.equals("imp") || type.equals("ZombieImp")) {
            return new Zombie(type, type, 190, 100, 0.22f, 20, 80);
        }

        // ====== 8. ALL STAR ======
        if (type.equals("allstar") || type.equals("ZombieModernAllStar")) {
            Zombie z = new Zombie(type, type, 1100, 1500, 0.22f, 42, 95);
        ...
        if (type.equals("arcade") || type.equals("ZombieArcade")) {
            Zombie z = new Zombie(type, type, 490, 100, 0.19f, 32, 95);
        ...
        if (type.equals("turquoise") || type.equals("ZombieCamelDefault")) {
            Zombie z = new Zombie(type, type, 380, 100, 0.185f, 32, 95);
        ...
        if (type.equals("prospector") || type.equals("ZombieProspector")) {
            Zombie z = new Zombie(type, type, 190, 100, 0.16f, 32, 95);
        ...
        if (type.equals("piano") || type.equals("ZombiePiano")) {
            Zombie z = new Zombie(type, type, 840, 4000, 0.12f, 75, 110);
        ...
        if (type.equals("newspaper") || type.equals("ZombieNewspaper")) {
            Zombie z = new Zombie(type, type, 460, 200, 0.22f, 32, 95);
        ...
        if (type.equals("barrel") || type.equals("ZombieBarrel")) {
            Zombie z = new Zombie(type, type, 100, 0, 0.185f, 32, 95);
        ...
        if (type.equals("ra") || type.equals("ZombieRa")) {
            Zombie z = new Zombie(type, type, 190, 100, 0.2f, 32, 95);
            z.addAbility(new SunRobbingAbility(250, 25));
            return z;
        }
        ...
        if (type.equals("explorer") || type.equals("ZombieExplorer")) {
            Zombie z = new Zombie(type, type, 250, 100, 0.25f, 32, 95);
        ...
        if (type.equals("dodo") || type.equals("ZombieIceAgeDodo")) {
            Zombie z = new Zombie(type, type, 490, 100, 0.3f, 46, 95);
        ...
        if (type.equals("hunter") || type.equals("ZombieIceAgeHunter")) {
            Zombie z = new Zombie(type, type, 700, 100, 0.12f, 32, 95);
        ...
        if (type.equals("troglobite") || type.equals("ZombieIceAgeTroglobite")) {
            Zombie z = new Zombie(type, type, 470, 100, 0.185f, 32, 95);
        ...
        if (type.equals("fisherman") || type.equals("ZombieBeachFisherman")) {
            Zombie z = new Zombie(type, type, 1000, 100, 0.185f, 32, 95);
        ...
        if (type.equals("snorkel") || type.equals("ZombieBeachSnorkel")) {
            Zombie z = new Zombie(type, type, 350, 100, 0.185f, 32, 105);
            return z;
        }

        // ====== 24. OCTOPUS ======
        if (type.equals("octopus") || type.equals("ZombieBeachOctopus")) {
            Zombie z = new Zombie(type, type, 910, 100, 0.12f, 32, 95);
            z.addAbility(new MoveAbility(MoveAbility.MoveType.THROW_OCTOPUS, 3.0f));
            return z;
        }

        // ====== 25. JUGGLER ======
        if (type.equals("juggler") || type.equals("ZombieDarkJuggler")) {
            Zombie z = new Zombie(type, type, 420, 100, 0.2f, 32, 95);
        ...
        if (type.equals("wizard") || type.equals("ZombieWizard")) {
            Zombie z = new Zombie(type, type, 490, 100, 0.12f, 32, 95);
        ...
        if (type.equals("dragon_imp") || type.equals("ZombieDarkImpDragon")) {
            Zombie z = new Zombie(type, type, 190, 100, 0.185f, 20, 80);
